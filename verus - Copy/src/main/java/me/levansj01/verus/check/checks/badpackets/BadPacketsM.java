package main.java.me.levansj01.verus.check.checks.badpackets;
...
@CheckInfo(
        ...
        minViolations = -2.0, 
        unsupportedVersions = {ClientVersion.VERSION1_7, ClientVersion.VERSION1_9, ClientVersion.VERSION1_13}   
)
